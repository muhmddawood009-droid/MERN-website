...
import { Calendar, LogOut, ShoppingCart, UserCircle, Package } from "lucide-react";
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center ml-20">
            <Link to="/" className="text-2xl font-bold text-blue-600">
              <img src="./logo-order.jpeg" alt="Logo" className="w-24" />
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <button onClick={() => navigate("/cart")} className="relative p-1 hover:bg-gray-100 rounded-lg transition-colors">
                ...
                <div className="relative">
                  ...
                  {isProfileOpen && (
                    <div
                      onMouseEnter={() => setIsProfileOpen(true)}
                      onMouseLeave={() => setIsProfileOpen(false)}
                      className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg pt-2 pb-2 border border-gray-100"
                    >
                      <Link
                        to="/my-bookings"
                      ...
                      <button onClick={logout} className="flex items-center w-full px-4 py-2 text-red-600 hover:bg-red-50 transition-colors">
