...
const Checkout = () => {
  ...
  return (
    <div className='max-w-5xl mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-white shadow-lg rounded-2xl'>
      {/* Left Side - Address */}
      <div>
        ...
        <textarea
          ...
          className='w-full border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-green-500 focus:outline-none resize-none'
        />
      </div>
          ...
          <div className='space-y-3'>
            ...
            <label className='flex items-center space-x-3'>
              <input
                ...
                name='payment'
                value="Other Payment"
                checked={paymentMethod === "Other Payment"}
                onChange={(e) => setPaymentMethod(e.target.value)}
              />
