          ...
          <div className='relative'>
            <div className='sticky top-8'>
              <div className='relative rounded-3xl overflow-hidden shadow-2xl'>
                <img src={menu.image} alt={menu.name} className='w-full h-[500px] object-cover'/>
                {/* Availability Badge */}
                <div className='absolute top-6 right-6'>
                  {menu.isAvailable ? (
                    <div className='bg-green-400 text-white px-4 py-2 rounded-full flex items-center gap-2 font-semibold shadow-lg'>
